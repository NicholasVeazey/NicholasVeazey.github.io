...
function getRandomAvailablePosition() {
  ...
  while (!spaceIsAvailable) {
    ...
    */
   /*
    if (randomPosition.column ==! snake.head.column && randomPosition.row ==! snake.head.row){
      spaceIsAvailable = true;
    }else if(randomPosition.column ==! snake.tail.column && randomPosition.row ==! snake.tail.row){
      spaceIsAvailable = true;
    }else if(randomPosition.column === snake.tail.column || randomPosition.row === snake.tail.row){
    ...
    */
  /*randomPosition.column === snake.tail.column || randomPosition.row === snake.tail.row*/ 
